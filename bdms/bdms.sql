...
-- ----------------------------
INSERT INTO `sys_message` VALUES ('18', '1', 'BDMS System 1.0上线', 'el-icon-info', '<h2><span style=\"color: rgb(230, 0, 0);\">系统部分</span></h2><p>包含用户管理，角色管理，权限管理，通知管理，</p><h2><span style=\"color: rgb(194, 133, 255);\">业务部分</span></h2><p>包含用户，课程，学科（未完成），职业，公司</p><h2><span style=\"color: rgb(255, 194, 102);\">爬虫部分（待完善，敬请期待）</span></h2>', '2020-03-26 10:43:24.000000', '1');
...
INSERT INTO `sys_message` VALUES ('21', '1', '下一次更新', 'el-icon-info', '<h2><span style=\"color: rgb(230, 0, 0);\">下一次更新估计将在半个月后</span></h2><p><br></p><ol><li><em style=\"color: rgb(0, 102, 204);\">主要涉及爬虫模块的探索 和 与之匹配的可视化页面的实现</em></li><li><em style=\"color: rgb(0, 102, 204);\">其次还有学科模块的实现</em></li></ol>', '2020-03-27 00:03:59.000000', '2');
