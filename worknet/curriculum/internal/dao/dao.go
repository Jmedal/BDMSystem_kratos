...
type Dao interface {
	...
	RawCurriculumTree(ctx context.Context) (resp *pb.WorknetCurriculumGraphResp, err error)
	RawCurriculumCourse(ctx context.Context) (resp *pb.WorknetCurriculumCourseResp, err error)
}
